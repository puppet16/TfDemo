...
public class DistinguishManager3 {
    private static final String LOG_TAG = DistinguishManager3.class.getSimpleName();
    ...
    public DistinguishManager3(Activity activity) throws IOException {
